...
<head>
    ...
    <!--
    <script src="js/BusinessRealtimeDetails.js"></script>
    -->
    <!-- Bootstrap Core CSS -->
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="page-header">
                        <button type="button" id="Changetime" aria-hidden="true">Change time</button>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class='input-group date page-header' id='startDate'  ">
                ...
                <div id="leftFeed">
                    <div class="Groupmembers">
                        ...
                        <div class="col-xs-4 col-md-4">
                            ...
                            <div style="text-align: center"><p><a href="http://facebook.com/'+value+'">test</a></p></div>
                        </div>
                        <div class="col-xs-4 col-md-4">
                            <div class="c100 p50 big">
                                <span>50%</span>
...
<script src="../js/Business/businessStaticsPage.js"></script>
